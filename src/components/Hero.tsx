  ...
  return (
    <section className='-mt-[5vh] bg-[url("/Assets/Img/lighthouse.png")] bg-contain bg-no-repeat bg-center lg:mt-0 lg:bg-[url("/Assets/Svg/5555.svg")] lg:bg-contain lg:bg-no-repeat lg:bg-center h-screen w-full flex flex-col items-center justify-center'>
      <div className='flex flex-col items-center'>
        ...
        <p className='mb-5 relative text-[45vw] headingE text-white text-center top-[-35vw] md:text-[43vw] md:top-[-27vw] lg:top-[1vw] lg:text-[22vw]'>die</p>
         <p className='relative text-[12vw] top-[-18vw] headingA text-red-800 text-center md:top-[-10vw] lg:text-[6vw] lg:top-[8vw]'>kiezkneipe</p>
      </div>
